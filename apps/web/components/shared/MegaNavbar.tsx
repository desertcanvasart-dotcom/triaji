    ...
    menus: [
      {
        ...
        columns: [
          { heading: '\u0627\u0644\u0631\u0639\u0627\u064a\u0629 \u0627\u0644\u0635\u062d\u064a\u0629', items: [
            ...
            { icon: '\u{1F9EA}', title: '\u0627\u0644\u062a\u062d\u0627\u0644\u064a\u0644 \u0648\u0627\u0644\u0623\u0634\u0639\u0629', description: '\u0627\u062d\u062c\u0632 \u0641\u064a \u0627\u0644\u0628\u0631\u062c \u0648\u0627\u0644\u0645\u062e\u062a\u0628\u0631 \u0648\u0623\u0644\u0641\u0627', href: '/ar/labs' },
            { icon: '\u{1F48A}', title: '\u0627\u0644\u0631\u0648\u0634\u062a\u0629 \u0648\u0627\u0644\u0635\u064a\u062f\u0644\u064a\u0629', description: '\u062a\u062a\u0628\u0639 \u0648\u0635\u0641\u062a\u0643 \u0645\u0646 \u0627\u0644\u0637\u0628\u064a\u0628 \u0644\u0644\u0635\u064a\u062f\u0644\u064a\u0629', href: '/ar/pharmacy' },
          ]},
        ...
        highlight: { icon: '\u{1F4BB}', title: '\u062f\u0643\u062a\u0648\u0631 \u062a\u0631\u064a\u0648', description: '\u0645\u0648\u0639\u062f \u0623\u0648\u0646\u0644\u0627\u064a\u0646 + \u0632\u064a\u0627\u0631\u0629 \u0648\u0627\u062d\u062f\u0629 + \u0645\u062a\u0627\u0628\u0639\u0629 \u0623\u0648\u0646\u0644\u0627\u064a\u0646 \u2014 \u0628\u062f\u0644 3 \u0632\u064a\u0627\u0631\u0627\u062a \u0628\u0633\u0639\u0631 \u0648\u0627\u062d\u062f', href: '/ar/doctor-trio' },
      } as MegaMenu,
      {
        ...
        columns: [
          ...
          { heading: '\u0625\u062f\u0627\u0631\u0629 \u0627\u0644\u0639\u064a\u0627\u062f\u0629', items: [
            ...
            { icon: '\u{1F4BB}', title: '\u062f\u0643\u062a\u0648\u0631 \u062a\u0631\u064a\u0648', description: '\u0627\u0644\u0645\u0648\u0639\u062f \u0627\u0644\u0623\u0648\u0644 \u0648\u0627\u0644\u062b\u0627\u0644\u062b \u0623\u0648\u0646\u0644\u0627\u064a\u0646\u060c \u0627\u0644\u062b\u0627\u0646\u064a \u0641\u064a \u0627\u0644\u0639\u064a\u0627\u062f\u0629', href: '/ar/doctor-trio' },
          ]},
        ],
        cta: { label: '\u0633\u062c\u0651\u0644 \u0643\u0637\u0628\u064a\u0628 \u0645\u062c\u0627\u0646\u0627\u064b', href: '/ar/doctor/register' },
        highlight: { icon: '\u{1F4BB}', title: '\u062f\u0643\u062a\u0648\u0631 \u062a\u0631\u064a\u0648', description: '\u0627\u0644\u0645\u0648\u0639\u062f \u0627\u0644\u0623\u0648\u0644 \u0648\u0627\u0644\u062b\u0627\u0644\u062b \u0623\u0648\u0646\u0644\u0627\u064a\u0646\u060c \u0627\u0644\u062b\u0627\u0646\u064a \u0641\u064a \u0627\u0644\u0639\u064a\u0627\u062f\u0629 \u2014 \u0628\u062f\u0644 3 \u0632\u064a\u0627\u0631\u0627\u062a', href: '/ar/doctor-trio' },
      } as MegaMenu,
      {
        ...
        cta: { label: '\u0633\u062c\u0651\u0644 \u0645\u0624\u0633\u0633\u062a\u0643 \u0627\u0644\u0622\u0646', href: '/ar/register/provider' },
    ...
    menus: [
      {
        ...
        columns: [
          { heading: 'Healthcare', items: [
            ...
            { icon: '\u{1F9EA}', title: 'Labs & Radiology', description: 'Book at Al-Borg, Al-Mokhtabar, and Alfa', href: '/en/labs' },
            { icon: '\u{1F48A}', title: 'Prescriptions & Pharmacy', description: 'Track your prescription from doctor to pharmacy', href: '/en/pharmacy' },
          ]},
        ...
        highlight: { icon: '\u{1F4BB}', title: 'Doctor Trio', description: 'Online consult + one clinic visit + online follow-up \u2014 instead of 3 trips, one price', href: '/en/doctor-trio' },
      } as MegaMenu,
      {
        ...
        columns: [
          ...
          { heading: 'Clinic Management', items: [
            ...
            { icon: '\u{1F4BB}', title: 'Doctor Trio', description: 'First and third appointments online, second in clinic', href: '/en/doctor-trio' },
          ]},
        ],
        cta: { label: 'Register as a doctor for free', href: '/en/doctor/register' },
        highlight: { icon: '\u{1F4BB}', title: 'Doctor Trio', description: 'First and third appointments online, second in clinic \u2014 instead of 3 trips', href: '/en/doctor-trio' },
      } as MegaMenu,
      {
        ...
        cta: { label: 'Register your institution', href: '/en/register/provider' },
