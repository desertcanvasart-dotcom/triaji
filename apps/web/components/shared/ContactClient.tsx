...
const CONTACT = {
  ar: {
    ...
    channels: [
      ...
      { icon: '📧', title: 'البريد الإلكتروني', value: 'support@triajji.com', description: 'بنرد خلال 24 ساعة', action: 'ابعت إيميل', href: 'mailto:support@triajji.com' },
    ],
    topics: [
      { icon: '🏥', label: 'للمستشفيات والعيادات', email: 'providers@triajji.com' },
      { icon: '👨‍⚕️', label: 'للأطباء', email: 'doctors@triajji.com' },
      { icon: '🛡️', label: 'للخصوصية والبيانات', email: 'privacy@triajji.com' },
      { icon: '📰', label: 'للإعلام والصحافة', email: 'press@triajji.com' },
    ],
    ...
    footer: { emergency: 'ترياچي ليس بديلاً عن الطوارئ — في حالات الطوارئ اتصل بـ 123', copyright: '© 2026 ترياچي. جميع الحقوق محفوظة.' },
  },
  en: {
    title: 'Contact Us',
    ...
    channels: [
      ...
      { icon: '📧', title: 'Email', value: 'support@triajji.com', description: 'We respond within 24 hours', action: 'Send email', href: 'mailto:support@triajji.com' },
    ],
    topics: [
      { icon: '🏥', label: 'For hospitals and clinics', email: 'providers@triajji.com' },
      { icon: '👨‍⚕️', label: 'For doctors', email: 'doctors@triajji.com' },
      { icon: '🛡️', label: 'For privacy and data', email: 'privacy@triajji.com' },
      { icon: '📰', label: 'For media and press', email: 'press@triajji.com' },
    ],
    ...
    footer: { emergency: 'Triajji is not a substitute for emergency services — call 123 in emergencies', copyright: '© 2026 Triajji. All rights reserved.' },
  },
};
