  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-sm p-6 w-full max-w-md text-center">
        ...
        {/* Receipt details */}
        <div className="bg-gray-50 rounded-xl p-4 mt-4 space-y-3 text-right">
          {reference && (
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-500" dir="ltr">{reference}</span>
          ...
          {amount && (
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-500" dir="ltr">{Number(amount).toFixed(2)} EGP</span>
              <span className="text-sm font-medium text-gray-700">
...
export default function ArabicPaySuccessPage() {
  return (
    <Suspense
      fallback={
