...
export default function EnglishHealthAssistantPage() {
  const lang = 'en';
  ...
  return (
    <main className="min-h-screen flex flex-col bg-gray-50" dir="ltr">
      {/* Header */}
      <header className="bg-teal-600 text-white py-4 px-6 shadow-md">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <a
              href="/en/medical-record"
      ...
      <div className="flex-1 flex overflow-hidden max-w-4xl mx-auto w-full">
        ...
        <aside
          ...
          } lg:block w-72 border-r border-gray-200 bg-white flex-shrink-0 overflow-hidden`}
        >
