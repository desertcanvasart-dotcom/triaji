...
const INITIAL_CONDITIONS: ChronicCondition[] = [
  { key: 'hypertension', label: 'Hypertension', checked: false },
  { key: 'diabetes', label: 'Diabetes', checked: false },
  { key: 'heart_disease', label: 'Heart disease', checked: false },
];
...
export default function QuickIntakePage() {
  ...
  return (
    <div className="p-6 sm:p-8 max-w-2xl mx-auto space-y-6 pb-12" dir="ltr">
      {/* Print styles */}
      <style>{`
        @media print {
      ...
      {/* Page header */}
      <div>
        <h1 className="text-2xl font-bold text-[#1A2F4A]">Quick intake</h1>
        <p className="text-sm text-gray-500 mt-1">
          Quick assessment for a walk-in patient without a prior appointment
        </p>
      </div>
      ...
      {!result ? (
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6 space-y-5">
            <h2 className="text-lg font-bold text-[#1A2F4A]">Basic information</h2>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Any hypertension, diabetes, or heart disease?
              </label>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
            <h2 className="text-lg font-bold text-[#1A2F4A]">Symptoms</h2>
            <textarea
              value={form.symptoms}
              onChange={(e) => updateSymptoms(e.target.value)}
              placeholder="e.g. Severe headache since morning with fever and neck pain"
              rows={5}
            ...
            />
            <p className="text-xs text-gray-400">Describe the patient&apos;s symptoms</p>
          </section>
          ...
          >
            {isSubmitting ? 'Analyzing...' : 'Run immediate assessment'}
          </button>
        </div>
      ) : (
        ...
        <div className="space-y-6">
          <section className="bg-white rounded-2xl shadow-sm p-6 space-y-5">
            <h2 className="text-lg font-bold text-[#1A2F4A]">Assessment result</h2>
            ...
            <div className="flex justify-center">
              ...
              >
                <span className="text-xs font-medium block mb-1">Urgency level</span>
            ...
            <div className="bg-teal-50 rounded-xl p-4 text-center">
              <span className="text-sm text-gray-600 block mb-1">Recommended specialty</span>
            ...
            {result.risk_factors.length > 0 && (
              <div>
                <h3 className="text-sm font-semibold text-gray-500 mb-2">Risk factors</h3>
            ...
            {/* Summary */}
            <div>
              <h3 className="text-sm font-semibold text-gray-500 mb-2">Assessment summary</h3>
            ...
            {result.next_steps.length > 0 && (
              <div>
                <h3 className="text-sm font-semibold text-gray-500 mb-2">Suggested next steps</h3>
            ...
            {result.red_flags.length > 0 && (
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-3">
                <h3 className="text-sm font-bold text-red-800">Warning signs</h3>
