  ...
  if (success) {
    return (
      <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
        ...
        <p className="text-lg font-semibold text-green-800">Appointment booked successfully!</p>
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-lg font-semibold text-gray-900">
        {bookingMode === 'slots_only' ? 'Book appointment' : 'Book an appointment'}
      </h2>
      ...
      {!loading && slotsByDate.size === 0 && (
        <div className="bg-white rounded-xl shadow-sm p-8 text-center">
          <p className="text-gray-400 text-sm">No slots available at the moment</p>
        </div>
      )}
