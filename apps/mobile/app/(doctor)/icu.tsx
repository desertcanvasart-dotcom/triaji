/**
 * Doctor ICU Screen — full search + transfer.
 * Same layout as patient ICU but with transfer request capability.
 */
...
import TransferRequestSheet from '@/components/icu/TransferRequestSheet';
...
export default function DoctorIcuScreen() {
